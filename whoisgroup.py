...
#        print(cmd)
    ...
    #First Message
    firstmessage = client.get_history(from_chat.id, limit=1, reverse=True)[0]["date"]
    ...
    timestamp = client.get_messages(from_chat.id, 1, replies=0).date
...
#    count = client.get_chat_members_count(from_chat.username)
    ...
    messagepinned= client.get_chat(from_chat.id)
